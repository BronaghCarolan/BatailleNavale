...
/**
 * Cette classe teste la classe Coordonnée.
 *
...
public class TestCoordonnee {
	public static void main(String[] args) {
		...
		/*
		 * Réponses egalité: true voisines: false compareTo: 0
		 */
		 testCoordonnee("A1",0,1);
		/*
		 * Réponses egalité: false voisines: true compareTo: <0
		 */
	...
	/**
	 * Cette méthode teste les constructeurs et les fonctions de la classe Coordonnee :
	 * toString(), getLigne(), getColonne(), equals(Coordonnee C), voisine(Coordonnee C), compareTo(Coordonnee C)
	 * 
	 * @param String s = coordonnées en forme de chaîne
	 * @param int x = ligne
	 * @param int y = colonne
	 */
	public static void testCoordonnee(String s, int x, int y) {
		...
		System.out.println("Egalité: " + c.equals(c2));
